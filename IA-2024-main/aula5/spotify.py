...
# Treinar
resultados = treinar_avaliar(X_train_processed,
                             y_train,
                             X_test_processed,
                             y_test)
...
resultados = resultados.sort_values(by='Acurácia')

# Criar gráfico de barras horizontais
fig = go.Figure()

fig.add_trace(go.Bar(name='F1 Score',
                     y=resultados['Modelo'],
                     x=resultados['F1 Score'],
                     orientation='h',
                     text=resultados['F1 Score'], textposition='outside'))

fig.add_trace(go.Bar(name='Acurácia', y=resultados['Modelo'],
                     x=resultados['Acurácia'],
                     orientation='h',
                     text=resultados['Acurácia'], textposition='outside'))

# Atualizar layout do gráfico
fig.update_layout(barmode='group',
                  title='Comparação de Acurácia e F1 Score por Modelo',
                  xaxis_title='Valor')
